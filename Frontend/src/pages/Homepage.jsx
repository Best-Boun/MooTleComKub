  ...
  return (
    <div className="tck-home">
      ...
      <section className="tck-hero">
        ...
        <h1 className="tck-title">ทุกสเปกที่ใช่<br />ในราคาที่คุ้ม</h1>
        ...
        <div className="tck-badges">
          <span className="tck-badge"><span className="tck-dot" />ของแท้ 100%</span>
          <span className="tck-badge"><span className="tck-dot" />ประกันศูนย์</span>
          <span className="tck-badge"><span className="tck-dot" />ชำระเงินปลอดภัย</span>
          <span className="tck-badge"><span className="tck-dot" />จัดส่งไว</span>
        </div>
      </section>
      ...
      <section className="tck-section">
        ...
        <div className="tck-spec-list">
          <div className="tck-spec-row">
            ...
            <span className="tck-spec-text"><b>สินค้าของแท้</b> — นำเข้าและจัดจำหน่ายโดยตัวแทนที่ได้รับการรับรอง</span>
          </div>
          <div className="tck-spec-row">
            <span className="tck-spec-mark tck-mono">WTY</span>
            <span className="tck-spec-text"><b>ประกันศูนย์</b> — รับประกันสินค้าตามมาตรฐานผู้ผลิตทุกชิ้น</span>
          </div>
          <div className="tck-spec-row">
            <span className="tck-spec-mark tck-mono">SEC</span>
            <span className="tck-spec-text"><b>ชำระเงินปลอดภัย</b> — ระบบชำระเงินเข้ารหัสมาตรฐานสากล</span>
          </div>
          <div className="tck-spec-row">
            <span className="tck-spec-mark tck-mono">SHP</span>
            <span className="tck-spec-text"><b>จัดส่งรวดเร็ว</b> — พร้อมติดตามสถานะพัสดุแบบเรียลไทม์</span>
          </div>
        </div>
      </section>
    </div>
